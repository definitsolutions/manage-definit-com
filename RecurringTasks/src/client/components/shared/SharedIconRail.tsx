// =============================================================================
// SharedIconRail - Fixed 48px icon rail (standalone mode for manage.definit.com)
// =============================================================================
...
const defaultItems: RailItem[] = [
  ...
  { id: 'recurring-tasks', icon: Repeat, label: 'Recurring Tasks', path: '/', external: false },
  ...
  return (
    <nav className="icon-rail" role="navigation" aria-label="Quick navigation">
      ...
      <div className="icon-rail-bottom">
        ...
        {onBugReport && (
          <button
            className="icon-rail-item icon-rail-bug"
            onClick={onBugReport}
            title="Report a Bug"
